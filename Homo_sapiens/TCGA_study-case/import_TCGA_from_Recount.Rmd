...
```{r}
table(pheno[, c("xml_lab_proc_her2_neu_immunohistochemistry_receptor_status", "xml_breast_carcinoma_estrogen_receptor_status")], useNA = TRUE)
table(pheno$xml_lab_proc_her2_neu_immunohistochemistry_receptor_status, useNA = TRUE)
