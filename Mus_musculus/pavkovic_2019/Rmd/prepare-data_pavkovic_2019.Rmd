...
```{r RNA-seq_count_distrib, fig.width=12, fig.height=10, out.width="100%", fig.cap="Distribution of raw counts"}
#### Count distrib ####
# head(rawCounts)
...
```{r log2_counts, fig.width=12, fig.height=5, out.width="100%"}
...
```{r box plots, fig.width=5, fig.height=7, out.width="50%"}
#### Box plots ####
par(mar = c(4, 6, 5, 1))
boxplot(log2Counts, 
        col = metadata$color,
...
We notice an obvious problem: the vast majority of counts is very small. This can result from different causes, whcih will not be investigted in this contet. 
...
Before going any further, it is important to ebsyre sile normalisation of the counts, in order to correct for biases due to inter-sample differences in sequencing depth. 
...
```{r median_normalisation, fig.width=5, fig.height=7, out.width="50%"}
