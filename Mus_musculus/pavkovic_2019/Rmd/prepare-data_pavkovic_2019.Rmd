...
We notice an obvious problem: the vast majority of counts is very small. This can result from different causes, which will not be investigted in this context. 
